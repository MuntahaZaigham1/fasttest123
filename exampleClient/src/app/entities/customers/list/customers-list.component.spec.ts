...
import { ICustomers, CustomersService, CustomersDetailsComponent, CustomersListComponent,
	CustomersNewComponent } from '../';
...
describe('CustomersListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/customers/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
