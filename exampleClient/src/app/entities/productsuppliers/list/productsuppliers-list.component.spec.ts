...
import { IProductsuppliers, ProductsuppliersService, ProductsuppliersDetailsComponent, ProductsuppliersListComponent,
	ProductsuppliersNewComponent } from '../';

describe('ProductsuppliersListComponent', () => {
  let fixture:ComponentFixture<ProductsuppliersListComponent>;
  let component:ProductsuppliersListComponent;
  let el: HTMLElement;
  
  let d = new Date();
  let t = DateUtils.formatDateStringToAMPM(d);
  let constData:IProductsuppliers[] = [
    {   
      productId: 1,
      supplierId: 1,
      productsDescriptiveField: 1,
      suppliersDescriptiveField: 1,
    },
    {   
      productId: 2,
      supplierId: 2,
      productsDescriptiveField: 2,
      suppliersDescriptiveField: 2,
    },
  ];
  let data: IProductsuppliers[] = [... constData];
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(ProductsuppliersListComponent);
  ...
  describe('Integration tests', () => {
    ...
    beforeEach(async(() => {
      ...
      TestBed.configureTestingModule({
        declarations: [
          ProductsuppliersListComponent,
          ProductsuppliersNewComponent,
          NewComponent,
          ProductsuppliersDetailsComponent,
          ListComponent,
          DetailsComponent,
          FieldsComp
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'productsuppliers', component: ProductsuppliersListComponent },
            { path: 'productsuppliers/:id', component: ProductsuppliersDetailsComponent }
          ])
        ],
        providers: [
          ProductsuppliersService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/productsuppliers/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
