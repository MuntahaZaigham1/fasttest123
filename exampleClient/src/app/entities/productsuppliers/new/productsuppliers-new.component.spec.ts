...
import { IProductsuppliers,ProductsuppliersService, ProductsuppliersNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('ProductsuppliersNewComponent', () => {
  let component: ProductsuppliersNewComponent;
  let fixture: ComponentFixture<ProductsuppliersNewComponent>;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(ProductsuppliersNewComponent);
