...
import { IProductsuppliers, ProductsuppliersService, ProductsuppliersDetailsComponent, ProductsuppliersListComponent } from '../';
...
describe('ProductsuppliersDetailsComponent', () => {
  let component: ProductsuppliersDetailsComponent;
  let fixture: ComponentFixture<ProductsuppliersDetailsComponent>;
  let el: HTMLElement;
  ...
  describe('Unit Tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(ProductsuppliersDetailsComponent);
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'productsuppliers', component: ProductsuppliersDetailsComponent },
            { path: 'productsuppliers/:id', component: ProductsuppliersListComponent }
          ])
        ],
        providers: [
          ProductsuppliersService
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/productsuppliers');
